    ...
    return (
        ...
        >
            <Image
                ...
                width={150}
                height={50}
                className="footer__logo footer-logo w-auto"
            />
            <p className="footer__text footer-text font-medium">
                Survived something that changed everything
            </p>
            <div className="flex items-center gap-4 mt-2">
                <Link
                    href="https://wa.me/917259956780"
                    target="_blank"
                ...
                <Link
                    href="https://www.instagram.com/thesamepinchh/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:opacity-80 transition-opacity inline-flex items-center justify-center"
