...
export default function InfoCarousel() {
    ...
    return (
        <section className="info-carousel info-carousel-section relative px-6 max-w-5xl mx-auto z-10 overflow-visible">
            ...
            <div className="hidden md:grid md:grid-cols-3 gap-6 md:gap-8">
                {cards.map((card, index) => (
                    <motion.div
                        ...
                        className="info-carousel__card info-carousel-card frosted-glass w-full max-w-full"
                    >
                        <h3 className="info-carousel__card-title info-carousel-card-title">
                            {card.title}:
                        </h3>
                        <p className="info-carousel__card-description info-carousel-card-description">
                            {card.content}
                        </p>
                    </motion.div>
                ))}
            ...
            <div className="block md:hidden relative w-full overflow-hidden info-carousel-mobile-container">
                <div className="relative w-full overflow-hidden info-carousel-mobile-container">
                    <AnimatePresence initial={false}>
                        ...
                        >
                            <div
                                ...
                                className="info-carousel__card info-carousel-card frosted-glass w-full mx-auto relative"
                            >
                                <div className="pb-20">
                                    <h3 className="info-carousel__card-title info-carousel-card-title">
                                        {cards[currentIndex].title}:
                                    </h3>
                                    <p className="info-carousel__card-description info-carousel-card-description mb-4">
                                ...
                                <div className="absolute bottom-4 left-6 right-6">
                                    {/* Progress fill bar */}
                                    <div className="info-carousel-progress-bar mb-2">
                                        <motion.div
                                            className="info-carousel-progress-fill"
                                            initial={{ width: '0%' }}
                                    ...
                                    <div className="flex gap-2 justify-center">
                                        {cards.map((_, index) => (
                                            <button
                                                ...
                                                className={`info-carousel-dot ${
                                                    index === currentIndex 
                                                        ? 'info-carousel-dot-active' 
                                                        : 'info-carousel-dot-inactive'
                                                }`}
                ...
                <button
                    onClick={() => paginate(-1)}
                    className="info-carousel-nav-button absolute left-1 top-1/2 -translate-y-1/2 z-30"
                ...
                <button
                    onClick={() => paginate(1)}
                    className="info-carousel-nav-button absolute right-1 top-1/2 -translate-y-1/2 z-30"
